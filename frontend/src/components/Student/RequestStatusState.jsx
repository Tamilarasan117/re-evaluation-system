...
const RequestStatusState = (props) => {
  const { requestCount, completedCount, inProgressCount, pendingCount } = props
      ...
      <div className='user-state-box1'>
        <div className="user-state-card student-box">
          ...
          <div className="user-state-content-card">
            ...
            <span className='users-count student-count'>{ inProgressCount }</span>
          </div>
        </div>
